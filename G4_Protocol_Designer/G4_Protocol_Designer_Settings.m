...
function settings = G4_Protocol_Designer_Settings(settingsIn)
    ...
    if exists(settingsIn, 'var')
        ...
        settings.processing_file = "C:\Users\taylo\Documents\Programming\Reiser\G4_Display_Tools\G4_Protocol_Designer\plotting_files\G4_Plot_Data_flyingdetector_pdf.m";
