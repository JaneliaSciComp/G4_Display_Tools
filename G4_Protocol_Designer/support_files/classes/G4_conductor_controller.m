...
=======
>>>>>>> bb6240a (Not fully tested: Changed experiment to run logging only each condition. Updated all data processing and conductor code to fit. Needs full testing on arena but seems to fix duration issue.)
