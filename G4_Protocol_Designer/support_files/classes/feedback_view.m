...
% Set up axes for plotting streamed data
            self.closeLoop_axis = axes(self.panel, 'units','normalized', 'Position', [.1, .67, .5 ,.2]);
            ...
            self.CL_function_box = uicontrol(self.panel, 'style', 'edit', 'String', ...
                ...
                'Position', [.63, .72, .25, .05], 'Callback', @self.new_CL_function);
            CL_browse_btn = uicontrol(self.panel, 'Style', 'pushbutton', 'String', 'Browse', ...
                'units', 'normalized', 'Position', [.89, .72, .1, .05], 'Callback', @self.CL_browse);
            self.openLoop_axis = axes(self.panel, 'units', 'normalized', 'Position', [.1, .37, .5, .2]);
            ...
            self.OL_function_box = uicontrol(self.panel, 'style', 'edit', 'String', ...
                ...
                'Position', [.63, .42, .25, .05], 'Callback', @self.new_OL_function);
            OL_browse_btn = uicontrol(self.panel, 'style', 'pushbutton', 'String', 'Browse', ...
                'units', 'normalized', 'Position', [.89, .42, .1, .05], 'Callback', @self.OL_browse);
