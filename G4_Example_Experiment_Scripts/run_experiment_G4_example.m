...
experiment_name = 'Motion1'; %name of experiment folder 
experiment_path = 'C:\matlabroot\G4\Experiments'; %(default save path is 'C:\matlabroot\G4\Experiments\')
...
userSettings;
experiment_folder = fullfile(experiment_path, experiment_name);
load(fullfile(experiment_folder, 'currentExp.mat'));
