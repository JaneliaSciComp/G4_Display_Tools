...
The first thing you need to do is [create any patterns](../G4_Pattern_Generator/About Pattern Generator.md):
![pattern](assets/Pattern.png)

and/or [functions](../G4_Function_Generator/About Function Generator.md):
