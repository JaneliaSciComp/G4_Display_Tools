...
%     experiment was ended early.
    ...
    [unaligned_ts_data, unaligned_ts_time, unaligned_inter_data, ...
 unaligned_inter_time] = get_unaligned_data(ts_data, num_ADC_chans, Log, ...
    ...
    % add data back onto the front if indicated by pre_dur (and add
    % negative numbers to the front of the timestamps array to associate
    % with it)
    ...
    % bad_conds = [bad_conds, bad_corr_conds, bad_conds_movement];
    % bad_reps = [bad_reps, bad_corr_reps, bad_reps_movement];
